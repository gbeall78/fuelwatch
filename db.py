...
def recordPrices(*args, **kwargs):
    """
        args[0] set to True gets todays prices.
    """
    c = kwargs['Cursor']
...
if __name__ == '__main__':
    #dbDataCheck()
    #recordPrices()
    #cProfile.run('searchServo(Product=2,Latlng=(-31.950527, 115.860458),Distance=5,Limit=3)',sort='time')
    #searchServo(Product=2,Latlng=(-31.950527, 115.860458),Distance=5,Limit=3)
    ...
    #p(searchServo(Suburb='Perth'))
    #p(searchServo(Suburb='Perth',Surrounding=True, Limit=20))